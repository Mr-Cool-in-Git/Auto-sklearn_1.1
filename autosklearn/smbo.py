...
def _get_metalearning_configurations(meta, meta_base, basename, metric,
                                     configuration_space,
                                     task,
    ...
    watcher.start_task(task_name)
    try:
        metalearning_configurations = suggest_via_metalearning(meta,
...
class AutoMLSMBO(object):
    ...
    def __init__(self, meta, config_space, dataset_name,
                 backend,
    ...
    def run_smbo(self):
        ...
        #print('1',metalearning_configurations)
        ...
        if self.num_metalearning_cfgs > 0:
            ...
            if os.path.exists(self.metadata_directory):
                ...
                self.logger.info('Metadata directory: %s',
                                 self.metadata_directory)
                meta_base = MetaBase(self.config_space, self.metadata_directory, self.logger, self.meta)

                # Calculate metafeatures for a new dataset
                ...
                #print('smbo:', meta_features)
                #print('smbo:', meta_features_encoded)
                ...
                #print(meta_features)
                #print(type(meta_features_encoded))
