...
class AlgorithmSelectionProblem(object):
    def __init__(self, directory):
        ...
        self.read_funcs = {
            ...
            # "feature_values_new_no_class.arff": self._read_feature_values,
            # "algorithm_runs_new.arff": self._read_algorithm_runs,
            # "configurations_new.csv": self._read_configurations,
    ...
    def _find_files(self):
        ...
        expected = [
            ...
            "algorithm_runs.arff",
            "feature_values.arff",
            # "algorithm_runs_new.arff",
            # "feature_values_new_no_class.arff",

            # "feature_runstatus.arff",
        ]
        # optional = ["ground_truth.arff", "feature_costs_new.arff", "citation.bib",
        #             "cv.arff", "configurations_new.csv"]
        #optional = ["configurations_new.csv"]
