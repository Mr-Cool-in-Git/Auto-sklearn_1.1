...
class MetaLearningOptimizer(object):
    def __init__(self, meta,dataset_name, configuration_space,
    ...
    def _learn(self, exclude_double_configurations=True):
        ...
        dataset_metafeatures = (dataset_metafeatures.loc[keep])#[:37-self.meta[1]]
        ...
        if self.kND is None:
            ...
            #all_other_metafeatures.to_csv('meta.csv')
            all_other_metafeatures = all_other_metafeatures #.drop(self.meta[0],axis=1)
            #print(all_other_metafeatures)
